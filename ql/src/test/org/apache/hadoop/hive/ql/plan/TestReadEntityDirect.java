...
public class TestReadEntityDirect {
  ...
  /**
   * No views so it should be a direct entity
   *
  ...
  /**
   * Underlying table should be marked as indirect
   *
   * @throws ParseException
   */
  @Test
  ...
  /**
   * Underlying table should be marked as direct, as it is also accessed
  ...
  /**
   * Underlying table should be marked as indirect. Query with join of views and aliases
   *
   * @throws ParseException
   */
  @Test
