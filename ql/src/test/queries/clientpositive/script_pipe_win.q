...
EXPLAIN SELECT TRANSFORM(key, value, key, value, key, value, key, value, key, value, key, value) USING 'cmd /c head -n 1' as a,b,c,d FROM src;

SELECT TRANSFORM(*) USING 'true' AS a, b, c FROM (SELECT * FROM src LIMIT 1) tmp;
SELECT TRANSFORM(key, value, key, value, key, value, key, value, key, value, key, value) USING 'cmd /c head -n 1' as a,b,c,d FROM src;
