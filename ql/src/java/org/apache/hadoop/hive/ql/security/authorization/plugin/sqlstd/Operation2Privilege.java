...
public class Operation2Privilege {
  ...
  static {
    ...
    op2Priv.put(HiveOperationType.CREATEDATABASE,
        new InOutPrivs(ADMIN_PRIV_AR, INS_SEL_DEL_NOGRANT_AR));
    ...
    op2Priv.put(HiveOperationType.ALTERTABLE_LOCATION, new InOutPrivs(OWNER_PRIV_AR, INS_SEL_DEL_NOGRANT_AR));
    op2Priv.put(HiveOperationType.ALTERPARTITION_LOCATION, new InOutPrivs(OWNER_PRIV_AR, INS_SEL_DEL_NOGRANT_AR));
    ...
    op2Priv.put(HiveOperationType.ALTERTBLPART_SKEWED_LOCATION, new InOutPrivs(OWNER_PRIV_AR, INS_SEL_DEL_NOGRANT_AR));
    ...
    op2Priv.put(HiveOperationType.CREATEINDEX, new InOutPrivs(OWNER_PRIV_AR, INS_SEL_DEL_NOGRANT_AR));
    ...
    op2Priv.put(HiveOperationType.ALTERTABLE_ADDPARTS, new InOutPrivs(SEL_NOGRANT_AR, INS_NOGRANT_AR));
    ...
    op2Priv.put(HiveOperationType.CREATETABLE,
        new InOutPrivs(OWNER_PRIV_AR, INS_SEL_DEL_NOGRANT_AR));
